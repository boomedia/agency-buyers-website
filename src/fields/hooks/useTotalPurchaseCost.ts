...
export const useTotalPurchaseCost = () => {
  ...
  const renovationsCost = form.getField('valueProposition.purchaseCost.renovationsCost').value as number;
  const buildingAndPest = form.getField('valueProposition.purchaseCost.buildingAndPest').value as number;
