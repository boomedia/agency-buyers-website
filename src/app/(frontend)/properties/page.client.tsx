    ...
    <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 group h-full">
      ...
      <CardContent className="p-6">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-6 text-sm">
            ...
            {property.generalInformation.format.bathrooms > 0 && (
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="font-semibold">{property.generalInformation.format.bathrooms}</div>
            ...
            {property.generalInformation.format.carSpaces > 0 && (
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="font-semibold">{property.generalInformation.format.carSpaces}</div>
          ...
          {/* Investment Yields - matching ValueProposition component styling */}
  ...
  const filteredProperties = useMemo(() => {
    return properties.filter(property => {
      ...
      if (searchTerm) {
        ...
        const matchesAddress = property.generalInformation.address.streetAddress.toLowerCase().includes(searchLower)
        const matchesSuburb = property.generalInformation.address.suburbName?.toLowerCase().includes(searchLower)
                ...
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600">
                    {filteredProperties.length > 0 
                      ? Math.round(filteredProperties.reduce((acc, p) => {
                          const yield1 = parseFloat(p.valueProposition.expectedResults.annualGrossYieldDisplay?.replace('%', '') || '0')
                          return acc + yield1
                        }, 0) / filteredProperties.length * 10) / 10
                      : 0}%
                  </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {(priceRange[0] !== 100000 || priceRange[1] !== 2000000) && (
                <Badge variant="secondary" className="cursor-pointer" onClick={() => setPriceRange([100000, 2000000])}>
