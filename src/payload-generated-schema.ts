...
export const comp_type = pgEnum('comp_type', ['superior', 'similar', 'inferior'])
...
export const enum_properties_general_information_address_state = pgEnum(
  'enum_properties_general_information_address_state',
...
export const enum__properties_v_version_general_information_address_state = pgEnum(
  'enum__properties_v_version_general_information_address_state',
  ['nsw', 'vic', 'qld', 'wa', 'sa', 'tas', 'act', 'nt'],
)
...
export const properties_general_information_agent_notes = pgTable(
  'properties_general_information_agent_notes',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('properties_general_information_agent_notes_order_idx').on(columns._order),
    _parentIDIdx: index('properties_general_information_agent_notes_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [properties.id],
      name: 'properties_general_information_agent_notes_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const properties_general_information_sale_history = pgTable(
  'properties_general_information_sale_history',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('properties_general_information_sale_history_order_idx').on(columns._order),
    _parentIDIdx: index('properties_general_information_sale_history_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [properties.id],
      name: 'properties_general_information_sale_history_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const properties_general_information_images = pgTable(
  'properties_general_information_images',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('properties_general_information_images_order_idx').on(columns._order),
    _parentIDIdx: index('properties_general_information_images_parent_id_idx').on(
      columns._parentID,
    ),
    properties_general_information_images_image_idx: index(
      'properties_general_information_images_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [properties.id],
      name: 'properties_general_information_images_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const properties_general_information_comparable_sales = pgTable(
  'properties_general_information_comparable_sales',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    ...
    comparison: comp_type('comparison'),
    link: varchar('link'),
    heroImage: integer('hero_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
  ...
  (columns) => ({
    _orderIdx: index('properties_general_information_comparable_sales_order_idx').on(
      columns._order,
    ),
    _parentIDIdx: index('properties_general_information_comparable_sales_parent_id_idx').on(
      columns._parentID,
    ),
    properties_general_information_comparable_sales_hero_image_idx: index(
      'properties_general_information_comparable_sales_hero_image_idx',
    ).on(columns.heroImage),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [properties.id],
      name: 'properties_general_information_comparable_sales_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const properties = pgTable(
  'properties',
  {
    id: serial('id').primaryKey(),
    name: varchar('name'),
    generalInformation_heroImage: integer('general_information_hero_image_id').references(
      () => media.id,
      {
        onDelete: 'set null',
      },
    ),
    generalInformation_agentSummary: jsonb('general_information_agent_summary'),
    generalInformation_videoUrl: varchar('general_information_video_url'),
    generalInformation_purchasePrice: numeric('general_information_purchase_price'),
    generalInformation_askingPrice: numeric('general_information_asking_price'),
    generalInformation_address_streetAddress: varchar('general_information_address_street_address'),
    generalInformation_address_suburbName: integer(
      'general_information_address_suburb_name_id',
    ).references(() => suburbs.id, {
      onDelete: 'set null',
    }),
    generalInformation_address_region: integer('general_information_address_region_id').references(
      () => regions.id,
      {
        onDelete: 'set null',
      },
    ),
    generalInformation_address_postcode: varchar('general_information_address_postcode'),
    generalInformation_address_state: enum_properties_general_information_address_state(
      'general_information_address_state',
    ),
    generalInformation_format_bedrooms: numeric('general_information_format_bedrooms'),
    generalInformation_format_bathrooms: numeric('general_information_format_bathrooms'),
    generalInformation_format_carSpaces: numeric('general_information_format_car_spaces'),
    generalInformation_internal: numeric('general_information_internal'),
    generalInformation_land: numeric('general_information_land'),
    generalInformation_buildYear: numeric('general_information_build_year'),
    ...
    valueProposition_purchaseCost_purchasePriceDisplay: varchar(
      'value_proposition_purchase_cost_purchase_price_display',
    ),
    valueProposition_purchaseCost_loanTerm: numeric(
      'value_proposition_purchase_cost_loan_term',
    ).default('30'),
    valueProposition_purchaseCost_interestRate: numeric(
      'value_proposition_purchase_cost_interest_rate',
    ),
    valueProposition_purchaseCost_depositCash: numeric(
      'value_proposition_purchase_cost_deposit_cash',
    ),
    valueProposition_purchaseCost_equityRelease: numeric(
      'value_proposition_purchase_cost_equity_release',
    ),
    valueProposition_purchaseCost_equityReleaseInterestRate: numeric(
      'value_proposition_purchase_cost_equity_release_interest_rate',
    ),
    valueProposition_purchaseCost_loanAmountDisplay: varchar(
      'value_proposition_purchase_cost_loan_amount_display',
    ),
    valueProposition_purchaseCost_depositTotalDisplay: varchar(
      'value_proposition_purchase_cost_deposit_total_display',
    ),
    valueProposition_purchaseCost_depositPercentageDisplay: varchar(
      'value_proposition_purchase_cost_deposit_percentage_display',
    ),
    valueProposition_purchaseCost_stampDuty: numeric('value_proposition_purchase_cost_stamp_duty'),
    valueProposition_purchaseCost_renovationsCost: numeric(
      'value_proposition_purchase_cost_renovations_cost',
    ),
    valueProposition_purchaseCost_buildingAndPest: numeric(
      'value_proposition_purchase_cost_building_and_pest',
    ),
    valueProposition_purchaseCost_conveyancing: numeric(
      'value_proposition_purchase_cost_conveyancing',
    ),
    valueProposition_purchaseCost_bankFees: numeric('value_proposition_purchase_cost_bank_fees'),
    valueProposition_purchaseCost_lendersMortgageInsurance: numeric(
      'value_proposition_purchase_cost_lenders_mortgage_insurance',
    ),
    valueProposition_purchaseCost_totalPurchaseCostDisplay: varchar(
      'value_proposition_purchase_cost_total_purchase_cost_display',
    ),
    valueProposition_annualExpenses_councilRates: numeric(
      'value_proposition_annual_expenses_council_rates',
    ),
    valueProposition_annualExpenses_insuranceCosts: numeric(
      'value_proposition_annual_expenses_insurance_costs',
    ),
    valueProposition_annualExpenses_utilities: numeric(
      'value_proposition_annual_expenses_utilities',
    ),
    valueProposition_annualExpenses_repairsAndMaintenance: numeric(
      'value_proposition_annual_expenses_repairs_and_maintenance',
    ),
    valueProposition_annualExpenses_pmPercentage: numeric(
      'value_proposition_annual_expenses_pm_percentage',
    ),
    valueProposition_annualExpenses_pmFeesDisplay: varchar(
      'value_proposition_annual_expenses_pm_fees_display',
    ),
    valueProposition_annualExpenses_loanRepaymentsDisp: varchar(
      'value_proposition_annual_expenses_loan_repayments_disp',
    ),
    valueProposition_annualExpenses_totalExpensesDisp: varchar(
      'value_proposition_annual_expenses_total_expenses_disp',
    ),
    valueProposition_expectedResults_expectedWeeklyRent: numeric(
      'value_proposition_expected_results_expected_weekly_rent',
    ),
    valueProposition_expectedResults_depreciationPotential: numeric(
      'value_proposition_expected_results_depreciation_potential',
    ),
    valueProposition_expectedResults_annualGrossIncomeDisplay: varchar(
      'value_proposition_expected_results_annual_gross_income_display',
    ),
    valueProposition_expectedResults_annualGrossYieldDisplay: varchar(
      'value_proposition_expected_results_annual_gross_yield_display',
    ),
    valueProposition_expectedResults_annualNetIncomeDisplay: varchar(
      'value_proposition_expected_results_annual_net_income_display',
    ),
    valueProposition_expectedResults_annualNetYieldDisplay: varchar(
      'value_proposition_expected_results_annual_net_yield_display',
    ),
    valueProposition_expectedResults_equityAt8Display: varchar(
      'value_proposition_expected_results_equity_at8_display',
    ),
    valueProposition_expectedResults_equityAt10Display: varchar(
      'value_proposition_expected_results_equity_at10_display',
    ),
    valueProposition_expectedResults_equityAt12Display: varchar(
      'value_proposition_expected_results_equity_at12_display',
    ),
    valueProposition_expectedResults_equityAt16Display: varchar(
      'value_proposition_expected_results_equity_at16_display',
    ),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
  ...
  (columns) => ({
    properties_general_information_general_information_hero_image_idx: index(
      'properties_general_information_general_information_hero_image_idx',
    ).on(columns.generalInformation_heroImage),
    properties_general_information_address_general_information_address_suburb_name_idx: index(
      'properties_general_information_address_general_information_address_suburb_name_idx',
    ).on(columns.generalInformation_address_suburbName),
    properties_general_information_address_general_information_address_region_idx: index(
      'properties_general_information_address_general_information_address_region_idx',
    ).on(columns.generalInformation_address_region),
...
export const _properties_v_version_general_information_agent_notes = pgTable(
  '_properties_v_version_general_information_agent_notes',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_properties_v_version_general_information_agent_notes_order_idx').on(
      columns._order,
    ),
    _parentIDIdx: index('_properties_v_version_general_information_agent_notes_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_properties_v.id],
      name: '_properties_v_version_general_information_agent_notes_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _properties_v_version_general_information_sale_history = pgTable(
  '_properties_v_version_general_information_sale_history',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_properties_v_version_general_information_sale_history_order_idx').on(
      columns._order,
    ),
    _parentIDIdx: index('_properties_v_version_general_information_sale_history_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_properties_v.id],
      name: '_properties_v_version_general_information_sale_history_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _properties_v_version_general_information_images = pgTable(
  '_properties_v_version_general_information_images',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_properties_v_version_general_information_images_order_idx').on(
      columns._order,
    ),
    _parentIDIdx: index('_properties_v_version_general_information_images_parent_id_idx').on(
      columns._parentID,
    ),
    _properties_v_version_general_information_images_image_idx: index(
      '_properties_v_version_general_information_images_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_properties_v.id],
      name: '_properties_v_version_general_information_images_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _properties_v_version_general_information_comparable_sales = pgTable(
  '_properties_v_version_general_information_comparable_sales',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_properties_v_version_general_information_comparable_sales_order_idx').on(
      columns._order,
    ),
    _parentIDIdx: index(
      '_properties_v_version_general_information_comparable_sales_parent_id_idx',
    ).on(columns._parentID),
    _properties_v_version_general_information_comparable_sales_hero_image_idx: index(
      '_properties_v_version_general_information_comparable_sales_hero_image_idx',
    ).on(columns.heroImage),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_properties_v.id],
      name: '_properties_v_version_general_information_comparable_sales_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _properties_v = pgTable(
  '_properties_v',
  {
    ...
    version_generalInformation_heroImage: integer(
      'version_general_information_hero_image_id',
    ).references(() => media.id, {
      onDelete: 'set null',
    }),
    version_generalInformation_agentSummary: jsonb('version_general_information_agent_summary'),
    version_generalInformation_videoUrl: varchar('version_general_information_video_url'),
    version_generalInformation_purchasePrice: numeric('version_general_information_purchase_price'),
    version_generalInformation_askingPrice: numeric('version_general_information_asking_price'),
    version_generalInformation_address_streetAddress: varchar(
      'version_general_information_address_street_address',
    ),
    version_generalInformation_address_suburbName: integer(
      'version_general_information_address_suburb_name_id',
    ).references(() => suburbs.id, {
      onDelete: 'set null',
    }),
    version_generalInformation_address_region: integer(
      'version_general_information_address_region_id',
    ).references(() => regions.id, {
      onDelete: 'set null',
    }),
    version_generalInformation_address_postcode: varchar(
      'version_general_information_address_postcode',
    ),
    version_generalInformation_address_state:
      enum__properties_v_version_general_information_address_state(
        'version_general_information_address_state',
      ),
    version_generalInformation_format_bedrooms: numeric(
      'version_general_information_format_bedrooms',
    ),
    version_generalInformation_format_bathrooms: numeric(
      'version_general_information_format_bathrooms',
    ),
    version_generalInformation_format_carSpaces: numeric(
      'version_general_information_format_car_spaces',
    ),
    version_generalInformation_internal: numeric('version_general_information_internal'),
    version_generalInformation_land: numeric('version_general_information_land'),
    version_generalInformation_buildYear: numeric('version_general_information_build_year'),
    ...
    version_valueProposition_purchaseCost_purchasePriceDisplay: varchar(
      'version_value_proposition_purchase_cost_purchase_price_display',
    ),
    version_valueProposition_purchaseCost_loanTerm: numeric(
      'version_value_proposition_purchase_cost_loan_term',
    ).default('30'),
    version_valueProposition_purchaseCost_interestRate: numeric(
      'version_value_proposition_purchase_cost_interest_rate',
    ),
    version_valueProposition_purchaseCost_depositCash: numeric(
      'version_value_proposition_purchase_cost_deposit_cash',
    ),
    version_valueProposition_purchaseCost_equityRelease: numeric(
      'version_value_proposition_purchase_cost_equity_release',
    ),
    version_valueProposition_purchaseCost_equityReleaseInterestRate: numeric(
      'version_value_proposition_purchase_cost_equity_release_interest_rate',
    ),
    version_valueProposition_purchaseCost_loanAmountDisplay: varchar(
      'version_value_proposition_purchase_cost_loan_amount_display',
    ),
    version_valueProposition_purchaseCost_depositTotalDisplay: varchar(
      'version_value_proposition_purchase_cost_deposit_total_display',
    ),
    version_valueProposition_purchaseCost_depositPercentageDisplay: varchar(
      'version_value_proposition_purchase_cost_deposit_percentage_display',
    ),
    version_valueProposition_purchaseCost_stampDuty: numeric(
      'version_value_proposition_purchase_cost_stamp_duty',
    ),
    version_valueProposition_purchaseCost_renovationsCost: numeric(
      'version_value_proposition_purchase_cost_renovations_cost',
    ),
    version_valueProposition_purchaseCost_buildingAndPest: numeric(
      'version_value_proposition_purchase_cost_building_and_pest',
    ),
    version_valueProposition_purchaseCost_conveyancing: numeric(
      'version_value_proposition_purchase_cost_conveyancing',
    ),
    version_valueProposition_purchaseCost_bankFees: numeric(
      'version_value_proposition_purchase_cost_bank_fees',
    ),
    version_valueProposition_purchaseCost_lendersMortgageInsurance: numeric(
      'version_value_proposition_purchase_cost_lenders_mortgage_insurance',
    ),
    version_valueProposition_purchaseCost_totalPurchaseCostDisplay: varchar(
      'version_value_proposition_purchase_cost_total_purchase_cost_display',
    ),
    version_valueProposition_annualExpenses_councilRates: numeric(
      'version_value_proposition_annual_expenses_council_rates',
    ),
    version_valueProposition_annualExpenses_insuranceCosts: numeric(
      'version_value_proposition_annual_expenses_insurance_costs',
    ),
    version_valueProposition_annualExpenses_utilities: numeric(
      'version_value_proposition_annual_expenses_utilities',
    ),
    version_valueProposition_annualExpenses_repairsAndMaintenance: numeric(
      'version_value_proposition_annual_expenses_repairs_and_maintenance',
    ),
    version_valueProposition_annualExpenses_pmPercentage: numeric(
      'version_value_proposition_annual_expenses_pm_percentage',
    ),
    version_valueProposition_annualExpenses_pmFeesDisplay: varchar(
      'version_value_proposition_annual_expenses_pm_fees_display',
    ),
    version_valueProposition_annualExpenses_loanRepaymentsDisp: varchar(
      'version_value_proposition_annual_expenses_loan_repayments_disp',
    ),
    version_valueProposition_annualExpenses_totalExpensesDisp: varchar(
      'version_value_proposition_annual_expenses_total_expenses_disp',
    ),
    version_valueProposition_expectedResults_expectedWeeklyRent: numeric(
      'version_value_proposition_expected_results_expected_weekly_rent',
    ),
    version_valueProposition_expectedResults_depreciationPotential: numeric(
      'version_value_proposition_expected_results_depreciation_potential',
    ),
    version_valueProposition_expectedResults_annualGrossIncomeDisplay: varchar(
      'version_value_proposition_expected_results_annual_gross_income_display',
    ),
    version_valueProposition_expectedResults_annualGrossYieldDisplay: varchar(
      'version_value_proposition_expected_results_annual_gross_yield_display',
    ),
    version_valueProposition_expectedResults_annualNetIncomeDisplay: varchar(
      'version_value_proposition_expected_results_annual_net_income_display',
    ),
    version_valueProposition_expectedResults_annualNetYieldDisplay: varchar(
      'version_value_proposition_expected_results_annual_net_yield_display',
    ),
    version_valueProposition_expectedResults_equityAt8Display: varchar(
      'version_value_proposition_expected_results_equity_at8_display',
    ),
    version_valueProposition_expectedResults_equityAt10Display: varchar(
      'version_value_proposition_expected_results_equity_at10_display',
    ),
    version_valueProposition_expectedResults_equityAt12Display: varchar(
      'version_value_proposition_expected_results_equity_at12_display',
    ),
    version_valueProposition_expectedResults_equityAt16Display: varchar(
      'version_value_proposition_expected_results_equity_at16_display',
    ),
    version_updatedAt: timestamp('version_updated_at', {
      mode: 'string',
      withTimezone: true,
  ...
  (columns) => ({
    ...
    _properties_v_version_general_information_version_general_information_hero_image_idx: index(
      '_properties_v_version_general_information_version_general_information_hero_image_idx',
    ).on(columns.version_generalInformation_heroImage),
    _properties_v_version_general_information_address_version_general_information_address_suburb_name_idx:
      index(
        '_properties_v_version_general_information_address_version_general_information_address_suburb_name_idx',
      ).on(columns.version_generalInformation_address_suburbName),
    _properties_v_version_general_information_address_version_general_information_address_region_idx:
      index(
        '_properties_v_version_general_information_address_version_general_information_address_region_idx',
      ).on(columns.version_generalInformation_address_region),
...
export const suburbs_median_value_by_year = pgTable(
  'suburbs_median_value_by_year',
  {
    ...
    medianValue: numeric('median_value').notNull(),
  },
  (columns) => ({
...
export const relations_properties_general_information_agent_notes = relations(
  properties_general_information_agent_notes,
  ({ one }) => ({
    _parentID: one(properties, {
      fields: [properties_general_information_agent_notes._parentID],
      references: [properties.id],
      relationName: 'generalInformation_agentNotes',
    }),
  }),
)
export const relations_properties_general_information_sale_history = relations(
  properties_general_information_sale_history,
  ({ one }) => ({
    _parentID: one(properties, {
      fields: [properties_general_information_sale_history._parentID],
      references: [properties.id],
      relationName: 'generalInformation_saleHistory',
    }),
  }),
)
export const relations_properties_general_information_images = relations(
  properties_general_information_images,
  ({ one }) => ({
    _parentID: one(properties, {
      fields: [properties_general_information_images._parentID],
      references: [properties.id],
      relationName: 'generalInformation_images',
    }),
    image: one(media, {
      fields: [properties_general_information_images.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations_properties_general_information_comparable_sales = relations(
  properties_general_information_comparable_sales,
  ({ one }) => ({
    _parentID: one(properties, {
      fields: [properties_general_information_comparable_sales._parentID],
      references: [properties.id],
      relationName: 'generalInformation_comparableSales',
    }),
    heroImage: one(media, {
      fields: [properties_general_information_comparable_sales.heroImage],
      references: [media.id],
      relationName: 'heroImage',
    }),
  }),
...
export const relations_properties = relations(properties, ({ one, many }) => ({
  generalInformation_heroImage: one(media, {
    fields: [properties.generalInformation_heroImage],
    references: [media.id],
    relationName: 'generalInformation_heroImage',
  }),
  generalInformation_agentNotes: many(properties_general_information_agent_notes, {
    relationName: 'generalInformation_agentNotes',
  }),
  generalInformation_address_suburbName: one(suburbs, {
    fields: [properties.generalInformation_address_suburbName],
    references: [suburbs.id],
    relationName: 'generalInformation_address_suburbName',
  }),
  generalInformation_address_region: one(regions, {
    fields: [properties.generalInformation_address_region],
    references: [regions.id],
    relationName: 'generalInformation_address_region',
  }),
  generalInformation_saleHistory: many(properties_general_information_sale_history, {
    relationName: 'generalInformation_saleHistory',
  }),
  generalInformation_images: many(properties_general_information_images, {
    relationName: 'generalInformation_images',
  }),
  generalInformation_comparableSales: many(properties_general_information_comparable_sales, {
    relationName: 'generalInformation_comparableSales',
  }),
...
export const relations__properties_v_version_general_information_agent_notes = relations(
  _properties_v_version_general_information_agent_notes,
  ({ one }) => ({
    _parentID: one(_properties_v, {
      fields: [_properties_v_version_general_information_agent_notes._parentID],
      references: [_properties_v.id],
      relationName: 'version_generalInformation_agentNotes',
    }),
  }),
)
export const relations__properties_v_version_general_information_sale_history = relations(
  _properties_v_version_general_information_sale_history,
  ({ one }) => ({
    _parentID: one(_properties_v, {
      fields: [_properties_v_version_general_information_sale_history._parentID],
      references: [_properties_v.id],
      relationName: 'version_generalInformation_saleHistory',
    }),
  }),
)
export const relations__properties_v_version_general_information_images = relations(
  _properties_v_version_general_information_images,
  ({ one }) => ({
    _parentID: one(_properties_v, {
      fields: [_properties_v_version_general_information_images._parentID],
      references: [_properties_v.id],
      relationName: 'version_generalInformation_images',
    }),
    image: one(media, {
      fields: [_properties_v_version_general_information_images.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations__properties_v_version_general_information_comparable_sales = relations(
  _properties_v_version_general_information_comparable_sales,
  ({ one }) => ({
    _parentID: one(_properties_v, {
      fields: [_properties_v_version_general_information_comparable_sales._parentID],
      references: [_properties_v.id],
      relationName: 'version_generalInformation_comparableSales',
    }),
    heroImage: one(media, {
      fields: [_properties_v_version_general_information_comparable_sales.heroImage],
      references: [media.id],
      relationName: 'heroImage',
    }),
  }),
...
export const relations__properties_v = relations(_properties_v, ({ one, many }) => ({
  ...
  version_generalInformation_heroImage: one(media, {
    fields: [_properties_v.version_generalInformation_heroImage],
    references: [media.id],
    relationName: 'version_generalInformation_heroImage',
  }),
  version_generalInformation_agentNotes: many(
    _properties_v_version_general_information_agent_notes,
    {
      relationName: 'version_generalInformation_agentNotes',
    },
  ),
  version_generalInformation_address_suburbName: one(suburbs, {
    fields: [_properties_v.version_generalInformation_address_suburbName],
    references: [suburbs.id],
    relationName: 'version_generalInformation_address_suburbName',
  }),
  version_generalInformation_address_region: one(regions, {
    fields: [_properties_v.version_generalInformation_address_region],
    references: [regions.id],
    relationName: 'version_generalInformation_address_region',
  }),
  version_generalInformation_saleHistory: many(
    _properties_v_version_general_information_sale_history,
    {
      relationName: 'version_generalInformation_saleHistory',
    },
  ),
  version_generalInformation_images: many(_properties_v_version_general_information_images, {
    relationName: 'version_generalInformation_images',
  }),
  version_generalInformation_comparableSales: many(
    _properties_v_version_general_information_comparable_sales,
    {
      relationName: 'version_generalInformation_comparableSales',
    },
...
type DatabaseSchema = {
  ...
  enum_properties_general_information_address_state: typeof enum_properties_general_information_address_state
  ...
  enum__properties_v_version_general_information_address_state: typeof enum__properties_v_version_general_information_address_state
  ...
  users: typeof users
  properties_general_information_agent_notes: typeof properties_general_information_agent_notes
  properties_general_information_sale_history: typeof properties_general_information_sale_history
  properties_general_information_images: typeof properties_general_information_images
  properties_general_information_comparable_sales: typeof properties_general_information_comparable_sales
  properties_due_diligence_zone_data: typeof properties_due_diligence_zone_data
  properties: typeof properties
  properties_rels: typeof properties_rels
  _properties_v_version_general_information_agent_notes: typeof _properties_v_version_general_information_agent_notes
  _properties_v_version_general_information_sale_history: typeof _properties_v_version_general_information_sale_history
  _properties_v_version_general_information_images: typeof _properties_v_version_general_information_images
  _properties_v_version_general_information_comparable_sales: typeof _properties_v_version_general_information_comparable_sales
  ...
  relations_properties_general_information_agent_notes: typeof relations_properties_general_information_agent_notes
  relations_properties_general_information_sale_history: typeof relations_properties_general_information_sale_history
  relations_properties_general_information_images: typeof relations_properties_general_information_images
  relations_properties_general_information_comparable_sales: typeof relations_properties_general_information_comparable_sales
  ...
  relations__properties_v_version_general_information_agent_notes: typeof relations__properties_v_version_general_information_agent_notes
  relations__properties_v_version_general_information_sale_history: typeof relations__properties_v_version_general_information_sale_history
  relations__properties_v_version_general_information_images: typeof relations__properties_v_version_general_information_images
  relations__properties_v_version_general_information_comparable_sales: typeof relations__properties_v_version_general_information_comparable_sales
